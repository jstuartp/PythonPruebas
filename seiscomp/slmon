...
def colorLegend(htmlfile):
    htmlfile.write("<p><center>Latencias:<br>\n" \
...
def pageTrailer(htmlfile, config): #Pie de pagina lo que va despues de la linea STUART
...
#inicio de la tabla cambiar si se va a usar datatables STUART
    ...
    <tr>
      <th bgcolor='#ffffff' align='center'>Datos</th>
      <th bgcolor='#ffffff' align='center'>Feed</th>
      <th bgcolor='#ffffff' align='center'>Diferencia.</th>
    </tr>
    """
    table_end = """
    </table>
...
def makeStatHTML(net_sta, config):
    ...
    <tr>
      <th bgcolor='#ffffff' align='center'>Ultima Muestra</th>
      <th bgcolor='#ffffff' align='center'>Latencia</th>
      <th bgcolor='#ffffff' align='center'>Ultimo Recibido</th>
      <th bgcolor='#ffffff' align='center'>Latencia</th>
    </tr>""")
