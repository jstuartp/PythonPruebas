...
# He eliminado la importación de joblib (Parallel, delayed)
...
def main():
    ...
    for i, archivo in enumerate(archivos, 1):
        # Imprimimos progreso para que veas qué está pasando
        ...
        # Guardar resultado y terminar la línea de impresión
